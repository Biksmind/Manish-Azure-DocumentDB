...
Before starting the hands-on migration steps, let's watch this short migration demo segment:

[Watch the migration demo video](https://youtu.be/OYtmeH0TSm4?t=410)

The video shows an example migration flow. After watching the demo, we will continue with the step-by-step hands-on instructions below.

**Note:** The instructor or sponsor will provide the temporary source MongoDB connection string during the workshop. Do not commit source credentials into this repository.
